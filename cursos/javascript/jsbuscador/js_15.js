...
function mostrarAutos(autos){
	...
	autos.forEach(auto => {
		...
		autoHTML.innerHTML = ` ${marca} -- ${modelo} -- ${year} -- ${precio} -- ${puertas} -- ${color} --${transmision}`
...
function noAutos(){
	...
	divMensaje.textContent = 'No se encontraron autos con esos criterios, intenta con otras opciones';
