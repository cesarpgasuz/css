...
function mostrarAutos(autos){
    ...
    autos.forEach(auto => {
        ...
        autoHTML.innerHTML = `
            ${marca} -- ${modelo} -- <strong>Año</strong> ${year}  -- <strong>Precio</strong> ${precio} --- <strong> ${puertas}</strong> Puertas -- Color <strong>${color} -- <strong>Trasmision</strgon> ${transmision} 
        `;
...
function noAutos(){
    ...
    error.textContent = 'No hay autos con esos criterios, intenta con otras opcioes';
