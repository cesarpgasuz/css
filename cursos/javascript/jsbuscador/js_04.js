...
function mostrarAuto(autos){
    ...
    autos.forEach( auto => {
        ...
        autoHTML.textContent = `
            ${auto.marca} - ${auto.modelo} -- Precio ${auto.precio} -- Año ${auto.year} - ${auto.puertas} Puertas -- ${auto.color} -- ${auto.transmision}
        `;
...
function noResultados(){
    ...
    nodatos.style.color = 'red';
    nodatos.textContent = 'no hay resultados, busca con otros terminos'

    resultado.appendChild(nodatos);
