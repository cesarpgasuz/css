...
function mostrarAutos(autos) {
	...
	autos.forEach(auto => {
		...
		autoHTML.innerHTML = `
			${marca} - ${modelo} -- <strong>${year}</strong> -- Precio ${precio} -- ${puertas} Puertas -- Color ${color} -- Transmision <strong>${transmision}</strong>
		`;
...
function noResultados(){
	...
	mensajeError.textContent = 'No se encontraron autos con esos criterios, intenta con otros terminos de busqueda'
