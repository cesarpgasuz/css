...
function mostrarAutos(autos){
    ...
    autos.forEach(auto => {
        ...
        row.innerHTML = `
            ...
            ${marca} -- Modelo ${modelo} -- <strong>Año ${year}</strong> -- Precio ${precio} -- <strong>${puertas} Puertas</strong> -- Color: ${color} -- <strong>Transmision: ${transmision}</strong> 
        `;
...
function noAutos(){
    ...
    mensaje.textContent = 'No se encontraron autos con esos criterios, intenta con otros';
